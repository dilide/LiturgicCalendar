	...
	*/
	{
        ...
        mapPropers.insert(std::make_pair(1102703,CellInfo(MEMORIAL,RED,"圣依纳爵主教•安提约基亚(殉道 St. Ignatius of Antioch)")));
        ...
        mapPropers.insert(std::make_pair(1121201,CellInfo(FEAST,WHITE,"圣瓜达卢佩圣母(Our Lady of Guadalupe)")));
